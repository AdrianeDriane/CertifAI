...
function DocumentsPage() {
  ...
  const { success, error: errorAuth } = useToast();
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
            ...
            <button className="bg-[#aa6bfe] text-white px-6 py-3 rounded-full hover:bg-opacity-90 transition-colors flex items-center gap-2 mt-4 sm:mt-0 shadow-sm">
          ...
          {filteredDocuments.length === 0 ? (
            <div className="bg-white rounded-2xl shadow-sm p-12 text-center border border-[#aa6bfe]/10">
              ...
              {documents.length === 0 && (
                <button className="bg-[#d0f600] text-[#000002] px-6 py-3 rounded-full hover:bg-opacity-90 transition-colors font-medium shadow-sm">
                  Create Document
                </button>
              )}
            </div>
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-4 relative">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-[#000002] group-hover:text-[#aa6bfe] transition-colors cursor-pointer">
                          {doc.title}
                        </h3>
